import ThanaMapSection from './components/ThanaMapSection';
import { THANAS_CONTENT } from './content';

export default function DccThanasPage() {
    return (
            ...
            <div className="border-b border-gray-200 bg-white px-4 py-6 dark:border-white/10 dark:bg-slate-900 sm:px-6">
                <div className="mx-auto max-w-7xl">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                        {THANAS_CONTENT.title}
                    </h1>
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {THANAS_CONTENT.subtitle}
                    </p>
                </div>
            </div>
