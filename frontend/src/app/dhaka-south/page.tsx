  ...
  return (
    <div className="flex-1 flex flex-col">
      <div className="bg-white border-b border-gray-200 px-6 py-4 z-10 flex-shrink-0">
        <h1 className="text-2xl font-extrabold text-indigo-900 tracking-tight">Dhaka South City Corporation</h1>
        <p className="text-sm text-gray-500 font-medium">Filtered view for DSCC wards and national constituencies.</p>
      </div>
